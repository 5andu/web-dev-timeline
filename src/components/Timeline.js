            ...
            <div class="timeline-container-left">
              ...
              <div class="bg-white p-6 rounded-md shadow-sm">
                ...
                <p>
                  ...
                  Webflow, on which I got more comfortable with thanks to{" "}
                  <a
          ...
          <div class="relative z-10">
            ...
            <div class="timeline-container-right">
              ...
              <div class="bg-white p-6 rounded-md shadow-sm">
                ...
                <span class="timeline-badge bg-purple-100 text-purple-800">
                  React
                </span>
          ...
          <div class="relative z-10">
            ...
            <div class="timeline-container-left">
              ...
              <div class="bg-white p-6 rounded-md shadow-sm">
                ...
                <p>
                  After a job in sales, my past experiences allowed me to get a
                  marketing job in the startup Bankin' during one year, where I
                  learned a lot about paid ads, design, and content creation. I
                  also created a page for them on Webflow.
                </p>
                <div class="flex justify-center mt-3">
                  <button class="block rounded-md border border-transparent bg-indigo-600 text-base font-medium text-white shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                    <a
          ...
          <div class="relative z-10">
            ...
            <div class="timeline-container-right">
              ...
              <div class="bg-white p-6 rounded-md shadow-sm">
                ...
                <p>
                  After creating my first business at 16 (and failing),
                  co-founding a clothing brand at 17. I gained experience
                  building websites, which made me able to get my first gig in
                  2018!
                </p>
                <div class="flex justify-center mt-3">
                  <button class="block rounded-md border border-transparent bg-indigo-600 text-base font-medium text-white shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
